...
function UpdateBannerCat(thisElem) {
  ...
  var catId = thisElem.children('option:selected').attr('value');
  var url = "".concat(baseURL, "/wp-json/wp/v2/pages?service_cat=").concat(catId, "&search=").concat(search);
  $.ajax({
    url: url
  }).done(function (data) {
    ...
    if (data[0] != undefined) {
      data.forEach(function (element) {
        $('.servicece-list').append("<li><a href=\"".concat(element.link, "\">").concat(element.title.rendered, "</a></li>"));
      });
    }
  });
}
