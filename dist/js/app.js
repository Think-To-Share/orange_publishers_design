...
$(window).on('load', function () {
  ...
  var aboutSectionVideoPaused = false;
  ...
  aboutSectionVideo.click(function () {
  ...
  $('#bannerServiceCat').change(function () {
    var catId = $(this).children('option:selected').attr('value');
    var url = "http://localhost/orange/wp-json/wp/v2/pages?service_cat=".concat(catId);
    $.ajax({
      url: url
    }).done(function (data) {
...
window.jquery = window.$ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"); // require('select2');
